...
WellnessEvent _buildEvent({String id = 'event-1', String title = 'Health Day'}) =>
    WellnessEvent(
      id: id,
      title: title,
...
void main() {
  ...
  group('EventViewModel – addEvent', () {
    ...
    test('sets errorMessage and rethrows when AddEventUseCase throws', () async {
      final vm = _buildViewModel(
        mockRepo: mockRepo,
        getUseCase: mockGetUseCase,
        addUseCase: mockAddUseCase,
  ...
  group('EventViewModel – loading state', () {
    test('isLoading transitions false → true → false across addEvent', () async {
      final vm = _buildViewModel(
        mockRepo: mockRepo,
        getUseCase: mockGetUseCase,
        addUseCase: mockAddUseCase,
