...
class ScreeningLocalStore {
  ...
  Future<List<Map<String, dynamic>>> _getAll(String table) async {
    try {
      final rows = await _db.customSelect('SELECT data FROM $table').get();
      return rows
          .map(
              (r) => jsonDecode(r.read<String>('data')) as Map<String, dynamic>)
          .toList();
  ...
  Future<void> upsertConsent(Map<String, dynamic> data) => _upsert(
      'cached_consents',
      data['id'] as String? ?? '',
  ...
  Future<void> upsertMemberEvent(Map<String, dynamic> data) => _upsert(
      'cached_member_events',
      data['id'] as String? ?? '',
      data['memberId'] as String? ?? '',
      data['eventId'] as String? ?? '',
  ...
  Future<List<Map<String, dynamic>>> getMemberEventsByMember(String memberId) =>
  ...
  Future<void> upsertHraScreening(Map<String, dynamic> data) => _upsert(
      'cached_hra_screenings',
      data['id'] as String? ?? '',
      data['memberId'] as String? ?? '',
      data['eventId'] as String? ?? '',
  ...
  Future<void> upsertTbScreening(Map<String, dynamic> data) => _upsert(
      'cached_tb_screenings',
      data['id'] as String? ?? '',
      data['memberId'] as String? ?? '',
      data['eventId'] as String? ?? '',
  ...
  Future<List<Map<String, dynamic>>> getTbScreeningsByMember(String memberId) =>
  ...
  Future<void> upsertCancerScreening(Map<String, dynamic> data) => _upsert(
      'cached_cancer_screenings',
      data['id'] as String? ?? '',
      data['memberId'] as String? ?? '',
      data['eventId'] as String? ?? '',
