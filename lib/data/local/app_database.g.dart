...
class $EventsTable extends Events with TableInfo<$EventsTable, EventEntity> {
  ...
  @override
  late final GeneratedColumn<String> aeContactNumber =
      GeneratedColumn<String>('ae_contact_number', aliasedName, false,
          type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _aeContactEmailMeta =
      const VerificationMeta('aeContactEmail');
  @override
  late final GeneratedColumn<String> aeContactEmail =
      GeneratedColumn<String>('ae_contact_email', aliasedName, false,
          type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  @override
  late final GeneratedColumn<int> expectedParticipation =
      GeneratedColumn<int>('expected_participation', aliasedName, false,
  ...
  @override
  late final GeneratedColumn<int> multiplyPromoters =
      GeneratedColumn<int>('multiply_promoters', aliasedName, false,
          type: DriftSqlType.int,
          requiredDuringInsert: false,
          defaultValue: const Constant(0));
  ...
  @override
  late final GeneratedColumn<String> strikeDownTime =
      GeneratedColumn<String>('strike_down_time', aliasedName, false,
          type: DriftSqlType.string,
          requiredDuringInsert: false,
          defaultValue: const Constant(''));
  ...
  @override
  late final GeneratedColumn<String> mobileBooths =
      GeneratedColumn<String>('mobile_booths', aliasedName, false,
          type: DriftSqlType.string,
          requiredDuringInsert: false,
          defaultValue: const Constant(''));
    ...
    if (data.containsKey('onsite_contact_first_name')) {
      context.handle(
          ...
          onsiteContactFirstName.isAcceptableOrUnknown(
              data['onsite_contact_first_name']!,
              _onsiteContactFirstNameMeta));
    } else if (isInserting) {
  ...
  EventEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return EventEntity(
      ...
      onsiteContactNumber: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}onsite_contact_number'])!,
      onsiteContactEmail: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}onsite_contact_email'])!,
      aeContactFirstName: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}ae_contact_first_name'])!,
      ...
      expectedParticipation: attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}expected_participation'])!,
...
class EventEntity extends DataClass implements Insertable<EventEntity> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['onsite_contact_first_name'] =
        Variable<String>(onsiteContactFirstName);
    ...
    map['expected_participation'] =
        Variable<int>(expectedParticipation);
  ...
  factory EventEntity.fromJson(Map<String, dynamic> json,
    ...
    return EventEntity(
      ...
      aeContactLastName:
          serializer.fromJson<String>(json['aeContactLastName']),
      ...
      servicesRequested:
          serializer.fromJson<String>(json['servicesRequested']),
      expectedParticipation:
      ...
      multiplyPromoters:
          serializer.fromJson<int>(json['multiplyPromoters']),
      ...
      actualStartTime:
          serializer.fromJson<DateTime?>(json['actualStartTime']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'onsiteContactLastName':
          serializer.toJson<String>(onsiteContactLastName),
      'onsiteContactNumber':
          serializer.toJson<String>(onsiteContactNumber),
      'onsiteContactEmail':
          serializer.toJson<String>(onsiteContactEmail),
      ...
      'expectedParticipation':
          serializer.toJson<int>(expectedParticipation),
      ...
      'multiplyPromoters':
          serializer.toJson<int>(multiplyPromoters),
      ...
      'actualStartTime':
          serializer.toJson<DateTime?>(actualStartTime),
  ...
  EventEntity copyWith(
      ...
      EventEntity(
        ...
        onsiteContactNumber:
            onsiteContactNumber ?? this.onsiteContactNumber,
  ...
  EventEntity copyWithCompanion(EventsCompanion data) {
    return EventEntity(
      ...
      strikeDownTime: data.strikeDownTime.present
          ...
          : this.strikeDownTime,
      mobileBooths:
          data.mobileBooths.present ? data.mobileBooths.value : this.mobileBooths,
      medicalAid:
...
class EventsCompanion extends UpdateCompanion<EventEntity> {
  ...
  static Insertable<EventEntity> custom({
    ...
    return RawValuesInsertable({
      ...
      if (aeContactLastName != null)
        'ae_contact_last_name': aeContactLastName,
      ...
      if (multiplyPromoters != null)
        'multiply_promoters': multiplyPromoters,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (onsiteContactEmail.present) {
      map['onsite_contact_email'] =
          Variable<String>(onsiteContactEmail.value);
    }
    if (aeContactFirstName.present) {
      map['ae_contact_first_name'] =
          Variable<String>(aeContactFirstName.value);
    }
    if (aeContactLastName.present) {
      map['ae_contact_last_name'] =
          Variable<String>(aeContactLastName.value);
    }
    if (aeContactNumber.present) {
      map['ae_contact_number'] =
          Variable<String>(aeContactNumber.value);
    }
    if (aeContactEmail.present) {
      map['ae_contact_email'] = Variable<String>(aeContactEmail.value);
    }
    if (servicesRequested.present) {
      map['services_requested'] =
          Variable<String>(servicesRequested.value);
    }
    ...
    if (multiplyPromoters.present) {
      map['multiply_promoters'] =
          Variable<int>(multiplyPromoters.value);
    }
    ...
    if (strikeDownTime.present) {
      map['strike_down_time'] =
          Variable<String>(strikeDownTime.value);
    }
    ...
    if (actualStartTime.present) {
      final value = actualStartTime.value;
      map['actual_start_time'] = value == null
          ? const Variable<DateTime?>(null)
          : Variable<DateTime>(value);
    }
    if (actualEndTime.present) {
      final value = actualEndTime.value;
      map['actual_end_time'] = value == null
          ? const Variable<DateTime?>(null)
          : Variable<DateTime>(value);
    }
    if (createdAt.present) {
