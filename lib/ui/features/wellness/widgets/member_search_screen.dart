        ...
        body: Column(
          children: [
            const KenwellGradientHeader(
              ...
              title: 'Member\nSearch',
              subtitle:
                  "Enter the member's ID or Passport number to search.",
            ),
            Expanded(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: ToggleButtons(
                  ...
                  constraints: const BoxConstraints(minHeight: 42, minWidth: 100),
                  children: const [
                    Padding(
          ...
          SizedBox(
            ...
            child: CustomPrimaryButton(
              label:
                  widget.isSearching ? 'Searching...' : 'Search Member',
...
class _MemberFoundCard extends StatelessWidget {
  const _MemberFoundCard(
      {required this.memberName, required this.onContinue});
