          ...
          return Padding(
            ...
            child: FilterChip(
              ...
              labelStyle: TextStyle(
                color: isSelected ? Colors.white : KenwellColors.neutralDarkGrey,
                fontWeight:
...
class _AuditEntryCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final dateStr = DateFormat('dd MMM yyyy HH:mm').format(entry.performedAt.toLocal());
...
class _AuditDetailSheet extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final dateStr = DateFormat('dd MMM yyyy HH:mm:ss')
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _DetailRow(label: 'Action', value: entry.action.toUpperCase()),
