      ...
      child: Column(
        children: [
          ...
          KenwellTextField(
            ...
            onTap: () =>
                _showTimePicker(context, viewModel.setUpTimeController),
          ),
          ...
          KenwellTextField(
            ...
            onTap: () =>
                _showTimePicker(context, viewModel.startTimeController),
          ),
          KenwellFormStyles.fieldSpacing,
          ...
          KenwellTextField(
            ...
            onTap: () =>
                _showTimePicker(context, viewModel.strikeDownTimeController),
          ),
        ],
      ),
    );
