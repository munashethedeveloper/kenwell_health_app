        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _StatusChip(
                  vm: vm, label: 'In Progress', value: 'in_progress'),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              isSelected ? KenwellColors.primaryGreen : Colors.grey.shade100,
...
class _SortChip extends StatelessWidget {
  const _SortChip(
      {required this.vm, required this.label, required this.field});
