    ...
    return Column(
      children: [
        ...
        KenwellTextField(
          ...
          validator: (val) =>
              (val == null || val.isEmpty) ? 'Please enter Email Address' : null,
        ),
        KenwellTextField(
          label: 'Cell Number',
    ...
    return Column(
      children: [
        KenwellTextField(
          ...
          validator: (val) =>
              (val == null || val.isEmpty) ? 'Please enter Medical Aid Name' : null,
        ),
        KenwellTextField(
          ...
          inputFormatters: AppTextInputFormatters.numbersOnly(),
          validator: (val) =>
              (val == null || val.isEmpty) ? 'Please enter Medical Aid Number' : null,
        ),
      ],
    );
  }
    ...
    return Column(
      children: [
        ...
        KenwellTextField(
          ...
          validator: (val) =>
              (val == null || val.isEmpty) ? 'Please enter Position / Rank' : null,
        ),
        KenwellDropdownField<String>(
          label: 'Province',
          value: vm.provinces,
