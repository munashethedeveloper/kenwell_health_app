      ...
      child: s.total == 0
          ...
          : Column(
              children: [
                ...
                Row(
                  children: [
                    buildPillStat('Underweight', s.underweight, Colors.blue, theme),
                    buildPillStat('Normal', s.normal, Colors.green, theme),
                    buildPillStat('Overweight', s.overweight, Colors.orange, theme),
                ...
                const Divider(),
                buildStatRow(Icons.smoking_rooms, 'Smokers', s.smokers,
                    s.total, Colors.brown, theme),
                if (s.topConditions.isNotEmpty) ...[
                  const Divider(height: 24),
                  buildScreeningSectionLabel('Top Chronic Conditions', theme),
                  const SizedBox(height: 8),
                  ...s.topConditions.map((e) =>
                      buildConditionRow(e.key, e.value, s.total, theme)),
                ],
              ],
            ),
    );
