...
class _EventStatsContentState extends State<EventStatsContent> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabFilteredEvents =
        statsVM.applyFilters(allEvents, isLiveTab: isLiveTab);
        ...
        child: Column(
          ...
          children: [
            ...
            LiveScreeningCountsSection(
              ...
              midSectionWidget: (_selectedScreeningType != null &&
  ...
  Widget _buildAnalyticsPanel(List<WellnessEvent> events, bool isLiveTab) {
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const Spacer(),
              TextButton.icon(
                onPressed: () => setState(() => _selectedScreeningType = null),
