...
class _EventStatsContentState extends State<EventStatsContent> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedProvince != null && _selectedProvince != 'All') {
      events =
          events.where((e) => e.province == _selectedProvince).toList();
    }
    ...
    if (_endDate != null) {
      events = events
          .where(
              (e) => e.date.isBefore(_endDate!.add(const Duration(days: 1))))
          .toList();
    }
              ...
              KenwellFormCard(
                ...
                child: Column(
                  children: eventsByProvince.entries.map((entry) {
                    final isLast =
                        entry == eventsByProvince.entries.last;
                    return Column(
                      children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isLiveTab ? 'Live Event Breakdown' : 'Past Event Breakdown',
                        style: const TextStyle(
                          fontSize: 15,
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
                color:
                    isSet ? theme.primaryColor : Colors.grey.shade300),
            borderRadius: BorderRadius.circular(8),
          ),
          child: Row(
            children: [
...
class _LiveScreeningCountsSectionState
  ...
  Widget build(BuildContext context) {
    ...
    final allScreenings = [
      ...
      _ScreeningCount(ServiceType.tbTest, 'TB', _tbCount,
      ...
      _ScreeningCount(ServiceType.psa, 'PSA', _psaCount,
