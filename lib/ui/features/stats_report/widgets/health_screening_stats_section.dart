...
class _HealthScreeningStatsSectionState
  ...
  Widget build(BuildContext context) {
    ...
    final hasAnyData =
        hra.total + cancer.total + tb.total + hct.total > 0;
      ...
      child: s.total == 0
          ...
          : Column(
              children: [
                ...
                // Key health risks
                _statRow(Icons.favorite, 'Hypertension',
                ...
                const Divider(),
                _statRow(Icons.smoking_rooms, 'Smokers',
                ...
                if (s.topConditions.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  ...s.topConditions.map((e) => _conditionRow(
                      e.key, e.value, s.total, theme)),
                ],
              ],
            ),
    );
  ...
  Widget _cancerCard(BuildContext context, _CancerStats s) {
    ...
    return KenwellFormCard(
      ...
      child: s.total == 0
          ...
          : Column(
              children: [
                _statRow(Icons.science, 'PAP Smear Collected',
                    '${s.papCollected} (${_pct(s.papCollected, s.total)})',
                    Colors.purple, theme),
                const Divider(),
                _statRow(Icons.warning_amber, 'PAP Smear Positive',
                    '${s.papPositive} (${_pct(s.papPositive, _den(s.papCollected, s.total))})',
                    Colors.deepPurple, theme),
                const Divider(),
                _statRow(Icons.biotech, 'PSA Test Done',
                    '${s.psaDone} (${_pct(s.psaDone, s.total)})',
                    Colors.indigo, theme),
                const Divider(),
                _statRow(Icons.error_outline, 'PSA Abnormal',
                ...
                _statRow(Icons.report_problem_outlined, 'Symptomatic',
                    ...
                    Colors.orange, theme),
                const Divider(),
                _statRow(Icons.local_hospital, 'Referred',
      ...
      child: s.total == 0
          ...
          : Column(
              children: [
                ...
                const SizedBox(height: 8),
                _statRow(Icons.air, 'Cough ≥2 weeks',
                    '${s.cough} (${_pct(s.cough, s.total)})',
                    Colors.orange, theme),
                const Divider(),
                _statRow(Icons.water_drop, 'Blood in Sputum',
                ...
                _statRow(Icons.trending_down, 'Unexplained Weight Loss',
                    ...
                    Colors.deepOrange, theme),
                const Divider(),
                _statRow(Icons.nightlight, 'Night Sweats',
                ...
                _statRow(Icons.history, 'Previous TB Treatment',
                    ...
                    Colors.blue, theme),
                const Divider(),
                _statRow(Icons.people_alt, 'Known TB Contact',
          ...
          : Column(
              children: [
                _statRow(Icons.person_add_alt_1, 'First-Time Testers',
                    ...
                    Colors.blue, theme),
                const Divider(),
                _statRow(Icons.warning, 'High-Risk Individuals',
